...
Plug 'sunliang711/nerdtree', { 'on':  'NERDTreeToggle'  }
Plug 'sunliang711/nerdtree-git-plugin'
...
"自动补全xml html标签
Plug 'sunliang711/closetag.vim'
"始终高亮包含当前光标位置的html标签,need python support
" Plug 'sunliang711/MatchTagAlways'

"切换主题插件
Plug 'sunliang711/change-colorscheme'
"注释插件
"快捷键gc（visual模式下）gcc(Normal 模式下)
Plug 'sunliang711/vim-commentary'
"起始页插件
Plug 'sunliang711/vim-startify'
"同时高亮所有的匹配单词
Plug 'sunliang711/incsearch.vim'
...
"添加整行: yss<new-char>
Plug 'sunliang711/vim-surround'
"使用surround操作之后，使用.号重复操作
Plug 'sunliang711/vim-repeat'

"自动添加结尾 比如有些语言输入if，会自动添加endif
Plug 'sunliang711/vim-endwise'
...
Plug 'sunliang711/ultisnips'
Plug 'sunliang711/vim-snippets'
...
"如果启用ycm的话，要把tab改成上面的，因为ycm的出发按键是tab
